...
class MainMenu extends \Ease\Html\NavTag {
    ...
    public function navBarCollapse() {
        ...
        $navbarNav = new \Ease\Html\UlTag(null, ['class' => 'navbar-nav me-auto  .navbar-expand mb-2 mb-lg-0', 'style' => "--bs-scroll-height: 100px;"]);
        ...
        $navbarNav->addItemSmart(new \Ease\Html\ATag('install.php', _('Installation'), ['class' => 'nav-link']), ['class' => 'nav-item']);

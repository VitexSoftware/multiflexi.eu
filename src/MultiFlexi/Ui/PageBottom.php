...
class PageBottom extends \Ease\Html\FooterTag
{
    ...
    public function finalize(): void
    {
        ...
        $docs = new \Ease\Html\ATag('/doc/', _('Documentation'), ['title' => _('Documentation')]);
        $footrow->addColumn(6, [$github, '&nbsp;', $linkedIn, '&nbsp;', $docs]);
